...
public class worker_LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (account.equals("admin") && password.equals("123456")) {
            ...
            editor.apply();
            Intent intent = new Intent(worker_LoginActivity.this, worker_mode.class);
            startActivity(intent);
            finish();
        }
        else
            {
            Toast.makeText(worker_LoginActivity.this, "account or password is invalid",
